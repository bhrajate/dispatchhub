...
### optimization-analysis.md 中列出的问题
...
- [x] **P0 1.4** CancelTask 未从 Redis 队列移除 — 已调用 `broker.Remove` + `broker.PublishCancel`（详见 [2026-04-16-task-cancellation.md](2026-04-16-task-cancellation.md)）
...
- [x] **P2 3.2** Scheduler 队列列表静态 — 已改为从 workers 动态计算（详见 [2026-04-16-scheduler-queues-consistency.md](2026-04-16-scheduler-queues-consistency.md)）
...
- [x] Leader Election 竞态条件（session/election 无锁读写） — 详见 [2026-04-16-election-race-fix.md](2026-04-16-election-race-fix.md)
- [x] Leader Election defer 顺序死锁 — 详见 [2026-04-17-election-defer-deadlock-fix.md](2026-04-17-election-defer-deadlock-fix.md)

### 路由增强（2026-04-17）

- [x] Queue-Type 路由校验 — 详见 [2026-04-17-queue-type-route-validation.md](2026-04-17-queue-type-route-validation.md)

---

## 二、未完成（低优先级）

### 已知遗留问题（来自 optimization-analysis.md）
